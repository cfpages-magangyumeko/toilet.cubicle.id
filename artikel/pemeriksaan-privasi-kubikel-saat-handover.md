---
article_id: CUB-14-02
title: "Pemeriksaan Gap dan Sightline saat Handover"
slug: "pemeriksaan-privasi-kubikel-saat-handover"
description: "Check room states, viewing paths, gaps, alignment, floor and door interfaces with records"
status: outline
publication_date: "2026-05-26"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: CUB-14
primary_intent: "Verify visual privacy"
reader_community: "Cubicle.id"
reader_address: "Kawan Cubicle.id"
final_route: "/artikel/pemeriksaan-privasi-kubikel-saat-handover.html"
...
# Pemeriksaan Gap dan Sightline saat Handover

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Pemeriksaan Gap dan Sightline saat Handover”
- **Reader and situation:** QA team
- **Reader outcome:** Check room states, viewing paths, gaps, alignment, floor and door interfaces with records
- **Primary intent:** Verify visual privacy
...
- **Scope boundary:** Does not promise acoustic privacy; CUB-09-05 owns scope
- **Final public route:** `/artikel/pemeriksaan-privasi-kubikel-saat-handover.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Pemeriksaan Gap dan Sightline saat Handover**.
...
- **Tie back to this article:** Keep the explanation specific to “Pemeriksaan Gap dan Sightline saat Handover”.
