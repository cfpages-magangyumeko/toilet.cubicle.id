---
article_id: CUB-16-04
title: "Audit Kubikel Eksisting sebelum Retrofit"
slug: "audit-kubikel-eksisting"
description: "Record identity, layout, substrate, panels, hardware, accessibility, hygiene, damage, parts and documents"
status: outline
publication_date: "2026-07-17"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: CUB-16
primary_intent: "Establish condition baseline"
reader_community: "Cubicle.id"
reader_address: "Kawan Cubicle.id"
final_route: "/artikel/audit-kubikel-eksisting.html"
...
# Audit Kubikel Eksisting sebelum Retrofit

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Audit Kubikel Eksisting sebelum Retrofit”
- **Reader and situation:** Owner planning upgrade
- **Reader outcome:** Record identity, layout, substrate, panels, hardware, accessibility, hygiene, damage, parts and documents
- **Primary intent:** Establish condition baseline
...
- **Scope boundary:** Does not certify reuse; CUB-16-05 owns intervention choice
- **Final public route:** `/artikel/audit-kubikel-eksisting.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Audit Kubikel Eksisting sebelum Retrofit**.
...
- `CUB-16-03` → `/artikel/bahaya-drilling-instalasi-kubikel.html` — Hidden Services, Debu Bor, dan Tile Pecah saat Instalasi
- `CUB-16-05` → `/artikel/repair-upgrade-atau-ganti-kubikel.html` — Repair, Upgrade, atau Ganti Toilet Cubicle?
- `CUB-16-06` → `/artikel/bongkar-reuse-dan-daur-ulang-kubikel.html` — Bongkar, Reuse, dan Daur Ulang Komponen Kubikel
...
- **Tie back to this article:** Keep the explanation specific to “Audit Kubikel Eksisting sebelum Retrofit”.
