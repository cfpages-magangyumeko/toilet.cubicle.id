---
article_id: CUB-07-03
title: "Lock, Indicator, Handle, dan Emergency Release"
slug: "lock-indicator-dan-emergency-release-kubikel"
description: "Cover reach, indication, release, tool access, robustness, corrosion and testing"
status: outline
publication_date: "2025-12-09"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: CUB-07
primary_intent: "Coordinate privacy and assistance"
reader_community: "Cubicle.id"
reader_address: "Kawan Cubicle.id"
final_route: "/artikel/lock-indicator-dan-emergency-release-kubikel.html"
...
# Lock, Indicator, Handle, dan Emergency Release

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Lock, Indicator, Handle, dan Emergency Release”
- **Reader and situation:** Designer selecting door hardware
- **Reader outcome:** Cover reach, indication, release, tool access, robustness, corrosion and testing
- **Primary intent:** Coordinate privacy and assistance
...
- **Scope boundary:** Does not certify accessibility; CUB-03-04 owns compliance coordination
- **Final public route:** `/artikel/lock-indicator-dan-emergency-release-kubikel.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Lock, Indicator, Handle, dan Emergency Release**.
...
- `CUB-07-01` → `/artikel/panduan-hardware-toilet-cubicle.html` — Panduan Hardware Toilet Cubicle
...
- **Tie back to this article:** Keep the explanation specific to “Lock, Indicator, Handle, dan Emergency Release”.
