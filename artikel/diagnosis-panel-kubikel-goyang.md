---
article_id: CUB-15-03
title: "Panel atau Pilaster Goyang: Apa yang Harus Diperiksa?"
slug: "diagnosis-panel-kubikel-goyang"
description: "Cover immediate isolation, feet, headrail, wall channel, fixings, substrate and impact history"
status: outline
publication_date: "2026-06-20"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: CUB-15
primary_intent: "Triage instability"
reader_community: "Cubicle.id"
reader_address: "Sobat Cubicle.id"
final_route: "/artikel/diagnosis-panel-kubikel-goyang.html"
...
# Panel atau Pilaster Goyang: Apa yang Harus Diperiksa?

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Panel atau Pilaster Goyang: Apa yang Harus Diperiksa?”
- **Reader and situation:** Operator or technician
- **Reader outcome:** Cover immediate isolation, feet, headrail, wall channel, fixings, substrate and impact history
- **Primary intent:** Triage instability
...
- **Scope boundary:** Does not allow continued use; CUB-16-01 owns public protection
- **Final public route:** `/artikel/diagnosis-panel-kubikel-goyang.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Panel atau Pilaster Goyang: Apa yang Harus Diperiksa?**.
...
- `CUB-15-01` → `/artikel/jadwal-maintenance-toilet-cubicle.html` — Jadwal Inspeksi dan Maintenance Toilet Cubicle
- `CUB-15-02` → `/artikel/diagnosis-pintu-kubikel-seret.html` — Pintu Kubikel Miring, Seret, atau Tidak Bisa Lock
- `CUB-15-04` → `/artikel/diagnosis-kerusakan-panel-kubikel.html` — Panel Retak, Chipping, Delaminasi, atau Vandalized
- `CUB-15-05` → `/artikel/diagnosis-kerusakan-area-basah-kubikel.html` — Noda Membandel, Bengkak, Jamur, dan Korosi pada Kubikel
...
- **Tie back to this article:** Keep the explanation specific to “Panel atau Pilaster Goyang: Apa yang Harus Diperiksa?”.
