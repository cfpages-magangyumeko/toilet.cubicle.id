---
article_id: CUB-13-03
title: "Drilling dan Fixing tanpa Merusak Tile atau Waterproofing"
slug: "drilling-dan-fixing-kubikel"
description: "Cover service scan, approved zones, bit and fixing evidence, membrane repair responsibility, dust and records"
status: outline
publication_date: "2026-05-05"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: CUB-13
primary_intent: "Coordinate penetrations safely"
reader_community: "Cubicle.id"
reader_address: "Sobat Cubicle.id"
final_route: "/artikel/drilling-dan-fixing-kubikel.html"
...
# Drilling dan Fixing tanpa Merusak Tile atau Waterproofing

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Drilling dan Fixing tanpa Merusak Tile atau Waterproofing”
- **Reader and situation:** Installer in finished wet area
- **Reader outcome:** Cover service scan, approved zones, bit and fixing evidence, membrane repair responsibility, dust and records
- **Primary intent:** Coordinate penetrations safely
...
- **Scope boundary:** Does not approve penetrations; waterproofing and structural authorities decide
- **Final public route:** `/artikel/drilling-dan-fixing-kubikel.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Drilling dan Fixing tanpa Merusak Tile atau Waterproofing**.
...
- `CUB-13-01` → `/artikel/kesiapan-site-instalasi-kubikel.html` — Checklist Kesiapan Lantai dan Dinding sebelum Instalasi Kubikel
- `CUB-13-02` → `/artikel/urutan-instalasi-toilet-cubicle.html` — Urutan Instalasi Kaki, Pilaster, Panel, dan Headrail
- `CUB-13-04` → `/artikel/penyetelan-pintu-dan-gap-kubikel.html` — Menyetel Gap, Plumb, Door Swing, dan Lock Kubikel
- `CUB-13-05` → `/artikel/sealant-interface-kubikel.html` — Sealant pada Interface Kubikel: Di Mana Perlu dan Tidak Perlu
...
- **Tie back to this article:** Keep the explanation specific to “Drilling dan Fixing tanpa Merusak Tile atau Waterproofing”.
