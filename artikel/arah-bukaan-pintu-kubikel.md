---
article_id: CUB-03-03
title: "Pintu Buka ke Dalam atau ke Luar pada Kubikel Toilet"
slug: "arah-bukaan-pintu-kubikel"
description: "Compare occupancy, rescue, circulation, hardware, clearance and obstruction"
status: outline
publication_date: "2025-09-08"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: CUB-03
primary_intent: "Choose door swing concept"
reader_community: "Cubicle.id"
reader_address: "Kawan Cubicle.id"
final_route: "/artikel/arah-bukaan-pintu-kubikel.html"
...
# Pintu Buka ke Dalam atau ke Luar pada Kubikel Toilet

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Pintu Buka ke Dalam atau ke Luar pada Kubikel Toilet”
- **Reader and situation:** Designer coordinating space
- **Reader outcome:** Compare occupancy, rescue, circulation, hardware, clearance and obstruction
- **Primary intent:** Choose door swing concept
...
- **Scope boundary:** Does not approve accessible or egress use; CUB-03-04 owns review
- **Final public route:** `/artikel/arah-bukaan-pintu-kubikel.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Pintu Buka ke Dalam atau ke Luar pada Kubikel Toilet**.
...
- `CUB-03-01` → `/artikel/cara-menyusun-layout-toilet-cubicle.html` — Cara Menyusun Layout Toilet Cubicle dari Ruang yang Ada
- `CUB-03-02` → `/artikel/privasi-dan-celah-toilet-cubicle.html` — Privasi Kubikel: Celah Pintu, Panel, Sightline, dan Suara
- `CUB-03-04` → `/artikel/checklist-kubikel-toilet-aksesibel.html` — Checklist Kubikel Toilet Aksesibel dan Ambulant
...
- **Tie back to this article:** Keep the explanation specific to “Pintu Buka ke Dalam atau ke Luar pada Kubikel Toilet”.
