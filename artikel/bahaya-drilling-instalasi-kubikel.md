---
article_id: CUB-16-03
title: "Hidden Services, Debu Bor, dan Tile Pecah saat Instalasi"
slug: "bahaya-drilling-instalasi-kubikel"
description: "Cover drawings, scanning, isolation, dust control, eye and hearing risk, fragments and stop-work triggers"
status: outline
publication_date: "2026-07-14"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: CUB-16
primary_intent: "Prevent drilling incidents"
reader_community: "Cubicle.id"
reader_address: "Sobat Cubicle.id"
final_route: "/artikel/bahaya-drilling-instalasi-kubikel.html"
...
# Hidden Services, Debu Bor, dan Tile Pecah saat Instalasi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Hidden Services, Debu Bor, dan Tile Pecah saat Instalasi”
- **Reader and situation:** Installer in existing toilet
- **Reader outcome:** Cover drawings, scanning, isolation, dust control, eye and hearing risk, fragments and stop-work triggers
- **Primary intent:** Prevent drilling incidents
...
- **Scope boundary:** Does not approve penetration; CUB-13-03 owns interface workflow
- **Final public route:** `/artikel/bahaya-drilling-instalasi-kubikel.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Hidden Services, Debu Bor, dan Tile Pecah saat Instalasi**.
...
- `CUB-16-01` → `/artikel/peta-bahaya-pekerjaan-kubikel.html` — Peta Bahaya Instalasi dan Perbaikan Toilet Cubicle
- `CUB-16-02` → `/artikel/handling-panel-kubikel-dengan-aman.html` — Mengangkat dan Menahan Panel Kubikel dengan Aman
- `CUB-16-04` → `/artikel/audit-kubikel-eksisting.html` — Audit Kubikel Eksisting sebelum Retrofit
- `CUB-16-05` → `/artikel/repair-upgrade-atau-ganti-kubikel.html` — Repair, Upgrade, atau Ganti Toilet Cubicle?
...
- **Tie back to this article:** Keep the explanation specific to “Hidden Services, Debu Bor, dan Tile Pecah saat Instalasi”.
