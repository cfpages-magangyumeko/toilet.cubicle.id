---
article_id: CUB-14-03
title: "Uji Door Swing, Lock, Indicator, dan Emergency Release"
slug: "uji-hardware-pintu-kubikel"
description: "Test repeated cycles, alignment, indication, release, handles, stops and assistance scenario"
status: outline
publication_date: "2026-05-31"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: CUB-14
primary_intent: "Verify door hardware operation"
reader_community: "Cubicle.id"
reader_address: "Sobat Cubicle.id"
final_route: "/artikel/uji-hardware-pintu-kubikel.html"
...
# Uji Door Swing, Lock, Indicator, dan Emergency Release

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Uji Door Swing, Lock, Indicator, dan Emergency Release”
- **Reader and situation:** QA and facility team
- **Reader outcome:** Test repeated cycles, alignment, indication, release, handles, stops and assistance scenario
- **Primary intent:** Verify door hardware operation
...
- **Scope boundary:** Does not certify accessibility; competent reviewer owns compliance
- **Final public route:** `/artikel/uji-hardware-pintu-kubikel.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Uji Door Swing, Lock, Indicator, dan Emergency Release**.
...
- `CUB-14-01` → `/artikel/commissioning-toilet-cubicle.html` — Commissioning Toilet Cubicle sebelum Handover
- `CUB-14-02` → `/artikel/pemeriksaan-privasi-kubikel-saat-handover.html` — Pemeriksaan Gap dan Sightline saat Handover
- `CUB-14-04` → `/artikel/pelatihan-cleaning-dan-inspeksi-kubikel.html` — Pelatihan Cleaning dan Inspeksi Harian Kubikel
- `CUB-14-05` → `/artikel/dokumen-handover-kubikel.html` — Dokumen Handover Kubikel: As-Built, Datasheet, Spares, dan Warranty
...
- **Tie back to this article:** Keep the explanation specific to “Uji Door Swing, Lock, Indicator, dan Emergency Release”.
